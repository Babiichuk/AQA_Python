...
adventures_of_tom_sawyer = ' '.join(adventures_of_tom_sawyer.split()).strip()
print(adventures_of_tom_sawyer)
...
print(sum(word[0].isupper() for word in adventures_of_tom_sawyer))

# task 06
""" Виведіть позицію, на якій слово Tom зустрічається вдруге
"""

print(adventures_of_tom_sawyer.find("Tom", 2))
...
adventures_of_tom_sawyer_sentences = [i for i in adventures_of_tom_sawyer_sentences if i]
...
print(adventures_of_tom_sawyer_sentences[3].strip().lower())

# task 09
""" Перевірте чи починається якесь речення з "By the time".
"""
for i in adventures_of_tom_sawyer_sentences:
    print(i.strip().startswith("By the time"))

# task 10
""" Виведіть кількість слів останнього речення з adventures_of_tom_sawyer_sentences.
"""

print(len(adventures_of_tom_sawyer_sentences[len(adventures_of_tom_sawyer_sentences) - 1].strip().split()))
